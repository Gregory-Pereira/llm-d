...
- [Kimi-K3 on H200](kimi-k3-h200.md) — TP=16 + expert-parallel P/D-disaggregated serving with DSpark speculative decoding and MooncakeStore tiered prefix caching on 8 H200 nodes (64 GPUs).
